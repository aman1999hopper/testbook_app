  ...
  return (
    <div class="py-3 px-5 mt-12 ">
        ...
        <div class="grid sm:grid-cols-3 grid-cols-1 gap-4">
            <div class="mt-10 border p-4 rounded-xl  hover:bg-gradient-to-r from-blue-500 to-blue-800 hover:text-white transform transition-transform duration-300 hover:scale-105">
            <div>
