...
export const HeroSection = () => {
  return (
    <div class="py-3 px-5 justify-center items-center grid md:grid-cols-2 grid-cols-1 bg-gradient-to-t from-teal-100 to-transparent rounded">
    <div class="left-side text-center"> 
      <h1 class="text-2xl font-bold">
        <span class="text-center font-normal">One Destination for</span>
        <br />
        Complete Exam Prepration
      </h1>
      <ul class="flex gap-2 mt-8 justify-center ">
    <li class="flex items-center">
      Learn
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#1CE26B"  class="bi bi-caret-right-fill ml-2" viewBox="0 0 16 16">
